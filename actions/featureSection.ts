...
export async function updateFeatureSection(sectionId: number, formData: FormData) {
...
export async function getFormattedServicesData(sectionId: number) {
  try {
    ...
    console.error('Error formatting feature data:', error);
    throw error;
  }
}